(module
  ...
  (func $fn_L24 (export "fn_L24") (type $bcpl_fn)
    ...
    (local.set $t7 (i32.const 1003032535))
    ...
    (local.set $t13 (i32.add (global.get $TB) (i32.const 0))) ;; LF L18
    ...
    (local.set $t10 (i32.const 1149239296))
    (local.set $t9 (i32.reinterpret_f32 (f32.mul (f32.reinterpret_i32 (local.get $t9)) (f32.reinterpret_i32 (local.get $t10)))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t9))
    (local.set $t5 (local.get $t9))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 1))) ;; LF L23
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t13)) ;; entry fn_idx
    ...
    (local.set $t6 (local.get $t9))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t9 (i32.trunc_f32_s (f32.reinterpret_i32 (local.get $t9))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L11
    ...
    (local.set $t9 (i32.trunc_f32_s (f32.reinterpret_i32 (local.get $t9))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L12
    (local.set $t10 (i32.add (local.get $t10) (local.get $t11)))
    (i32.store (i32.shl (local.get $t10) (i32.const 2)) (local.get $t9))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
  ...
  (func $fn_L27 (export "fn_L27") (type $bcpl_fn)
    ...
    (local.set $t7 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L12
    ...
    (local.set $t8 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L11
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t14))
    (local.set $t10 (local.get $t14))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L30 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L30
    ...
    (local.set $t17 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L10
    (local.set $t16 (i32.add (local.get $t16) (local.get $t17)))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L32 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L32
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    ...
    (if (i32.le_s (local.get $t14) (local.get $t15)) (then
      ...
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L29 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L29
  ...
  (func $fn_L35 (export "fn_L35") (type $bcpl_fn)
    ...
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L14
    (local.set $t12 (i32.const 0))
    (local.set $t13 (i32.const 0))
    (local.set $t14 (i32.const 320))
    (local.set $t15 (i32.const 120))
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L15
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t17)) ;; entry fn_idx
    ...
    (local.set $t14 (i32.const 320))
    (local.set $t15 (i32.const 120))
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L16
    (local.set $t17 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
    (local.set $t15 (i32.add (global.get $TB) (i32.const 3))) ;; LF L27
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    ...
    (local.set $t17 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L14
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15)) ;; flush t15 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16)) ;; flush t16 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (local.get $t17)) ;; flush t17 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t18)) ;; flush t18 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19)) ;; flush t19 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t20)) ;; flush t20 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t21)) ;; flush t21 (pre-stack-up)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t23)) ;; entry fn_idx
    ...
    (if (i32.le_s (local.get $t8) (local.get $t9)) (then
      ...
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L37 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L37
    (local.set $t9 (i32.const 66))
    (local.set $t10 (i32.const 17))
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L14
  ...
  (func $fn_L39 (export "fn_L39") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (local.get $t3)) ;; flush t3 (pre-stack-up)
      (local.set $__lab (i32.const 9)) (br $__dispatch) ;; JUMP L41
    ...
    (local.set $t15 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52))))
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
    (local.set $t15 (i32.add (local.get $t15) (local.get $t16)))
    (i32.store (i32.shl (local.get $t15) (i32.const 2)) (local.get $t14))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L45 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L45
    ...
    (i32.store
      ...
      (local.get $t14))
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L44
    )) ;; end block / LAB L46 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L46
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L44
    )) ;; end block / LAB L42 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L42
    ...
    (i32.store (i32.shl (local.get $t15) (i32.const 2)) (local.get $t14))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L48 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L48
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L47 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L47
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L44 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L44
    ...
    (i32.store
      ...
      (local.get $t14))
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L49 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L49
  ...
  (func $fn_L50 (export "fn_L50") (type $bcpl_fn)
    ...
    (local.set $t4 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t5 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
  ...
  (func $fn_L52 (export "fn_L52") (type $bcpl_fn)
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L54 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L54
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    ;; RTRN
  ...
  (func $fn_L55 (export "fn_L55") (type $bcpl_fn)
    ...
    (loop $__dispatch
    (if (i32.eqz (local.get $__lab)) (then ;; entry block
    (local.set $t3 (i32.const 3584))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (local.get $t3)) ;; STORE slot 3
    (local.set $t4 (i32.const 5632))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (local.get $t4)) ;; STORE slot 4
    (local.set $t5 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (local.set $t6 (i32.add (global.get $SB) (i32.const 8))) ;; LLL L56
    (i32.store
      (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2))
      (local.get $t6))
    (local.set $t9 (i32.const 66))
    ...
    (local.set $t8 (i32.const 0))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t10 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    ...
    (local.set $t7 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
    (local.set $t11 (i32.add (global.get $TB) (i32.const 6))) ;; LF L39
    ...
    (local.set $t12 (i32.add (global.get $TB) (i32.const 7))) ;; LF L50
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t6 (local.get $t8))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L61 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L61
    ...
    (local.set $t6 (local.get $t8))
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L63 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L63
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L65 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L65
    ...
    (if (i32.eqz (local.get $t8)) (then
      ...
      (local.set $__lab (i32.const 10)) (br $__dispatch)
    )) ;; end block / LAB L68 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L68
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L67 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L67
    (local.set $t8 (i32.const 0))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    ...
    (local.set $t9 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L12
    (local.set $t8 (i32.add (local.get $t8) (local.get $t9)))
    ...
    (local.set $t10 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L11
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    (local.set $t9 (i32.load (i32.shl (local.get $t9) (i32.const 2))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    ...
    (local.set $t17 (i32.add (global.get $TB) (i32.const 8))) ;; LF L52
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t17)))
      (local.set $__lab (i32.const 12)) (br $__dispatch)
    )) ;; end block / LAB L69 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L69
    (local.set $t8 (i32.const 0))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (if (i32.eq  (local.get $t8) (local.get $t9)) (then
    ...
    (local.set $t5 (local.get $t8))
      (local.set $__lab (i32.const 13)) (br $__dispatch)
    )) ;; end block / LAB L70 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L70
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 5))) ;; LF L35
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    ...
    (if (local.get $t6) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L60 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L60
    (local.set $t9 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L11
    ...
    (global.set $P (i32.add (global.get $P) (i32.const 6)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t10)))
    (local.set $t9 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 108))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (i32.const 0)) ;; return addr placeholder
  ...
  (elem $ftab funcref (ref.func $fn_L18) (ref.func $fn_L23) (ref.func $fn_L24) (ref.func $fn_L27) (ref.func $fn_L33) (ref.func $fn_L35) (ref.func $fn_L39) (ref.func $fn_L50) (ref.func $fn_L52) (ref.func $fn_L55))

  ;; static data — passive segment (77 words)
  (data $stat "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\11\72\61\79\63\61\73\74\65\72\20\65\78\69\74\65\64\0A\00\00")
