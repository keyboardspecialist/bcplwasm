(module
  ...
  (func $fn_L27 (export "fn_L27") (type $bcpl_fn)
    ...
    (local.set $t15 (i32.load (i32.add (local.get $Pb) (i32.const 40))))
    (local.set $t14 (i32.add (local.get $t14) (local.get $t15)))
    (i32.store (i32.add (local.get $Pb) (i32.const 40)) (local.get $t14))
    ...
    (local.set $t14 (i32.add (local.get $t14) (local.get $t15)))
    (i32.store (i32.add (local.get $Pb) (i32.const 44)) (local.get $t14))
    ...
    (local.set $t14 (i32.add (local.get $t14) (local.get $t15)))
    (i32.store (i32.add (local.get $Pb) (i32.const 48)) (local.get $t14))
  ...
  (func $fn_L35 (export "fn_L35") (type $bcpl_fn)
    ...
    (local.set $t14 (i32.div_s (local.get $t14) (local.get $t15)))
    (i32.store (i32.add (local.get $Pb) (i32.const 52)) (local.get $t14))
    ...
    (local.set $t20 (i32.load (i32.add (local.get $Pb) (i32.const 24))))
    ...
    (i32.store (i32.add (local.get $Pb) (i32.const 68)) (local.get $t17)) ;; flush t17 (pre-stack-up)
    (i32.store (i32.add (local.get $Pb) (i32.const 72)) (local.get $t18)) ;; flush t18 (pre-stack-up)
    ...
    (i32.store (i32.add (local.get $Pb) (i32.const 88)) (local.get $t22)) ;; flush t22 (pre-stack-up)
    (i32.store (i32.add (local.get $Pb) (i32.const 92)) (local.get $t23)) ;; flush t23 (pre-stack-up)
    (local.set $t27 (i32.load (i32.add (local.get $Pb) (i32.const 44))))
    ...
    (i32.store (i32.add (local.get $Pb) (i32.const 64)) (local.get $t25)) ;; entry fn_idx
