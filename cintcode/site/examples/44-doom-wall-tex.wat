(module
  ...
  (func $fn_L47 (export "fn_L47") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9)) ;; STORE slot 9
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L49
    ...
    )) ;; end block / LAB L49 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L49
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
  ...
  (func $fn_L50 (export "fn_L50") (type $bcpl_fn)
    ...
    (local.set $t10 (i32.load8_u (i32.add (i32.shl (local.get $t10) (i32.const 2)) (local.get $t11))))
    (local.set $t11 (i32.add (global.get $TB) (i32.const 0))) ;; LF L45
    ...
    (local.set $t12 (i32.add (global.get $TB) (i32.const 0))) ;; LF L45
  ...
  (func $fn_L52 (export "fn_L52") (type $bcpl_fn)
    ...
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L53
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L56
    ...
    )) ;; end block / LAB L56 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L56
    (local.set $t107 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 424))))
    (local.set $t108 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 416))))
    (if (i32.gt_s (local.get $t107) (local.get $t108)) (then
    ...
    (local.set $t113 (i32.add (global.get $TB) (i32.const 2))) ;; LF L50
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 440)) (local.get $t110))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 444)) (local.get $t111))
    ...
    (local.set $t114 (i32.add (global.get $TB) (i32.const 1))) ;; LF L47
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 440)) (local.get $t110))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 444)) (local.get $t111))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 448)) (local.get $t112))
    ...
    (local.set $t110 (i32.add (global.get $SB) (i32.const 35))) ;; LSTR
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 432)) (local.get $t108)) ;; STORE slot 108
      (local.set $__lab (i32.const 6)) (br $__dispatch) ;; JUMP L61
    ...
    )) ;; end block / LAB L61 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L61
    (local.set $t109 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 428))))
    ...
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L59
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L58 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L58
    (local.set $t107 (i32.const 1))
    (local.set $t108 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 424))))
    (local.set $t107 (i32.add (local.get $t107) (local.get $t108)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 424)) (local.get $t107))
    ...
    (if (i32.le_s (local.get $t107) (local.get $t108)) (then
      ...
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L54 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L54
  ...
  (func $fn_L64 (export "fn_L64") (type $bcpl_fn)
    ...
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
  ...
  (func $fn_L66 (export "fn_L66") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8)) ;; STORE slot 8
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L69
    )) ;; end block / LAB L68 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L68
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L70 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L70
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.const 1))
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    ...
    (if (i32.gt_s (local.get $t9) (local.get $t10)) (then
      ...
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L71 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L71
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t10 (i32.const 8))
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (local.get $t10) (local.get $t11)))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L73 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L73
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.const 1))
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t9))
  ...
  (func $fn_L74 (export "fn_L74") (type $bcpl_fn)
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L76 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L76
    (local.set $t11 (i32.const 0))
    ;; FNRN
    (local.set $__res (local.get $t11))
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
  ...
  (func $fn_L77 (export "fn_L77") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6)) ;; STORE slot 6
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L79
    ...
    (local.set $t5 (local.get $t7))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L79 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L79
    (local.set $t7 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (if (i32.le_s (local.get $t7) (local.get $t8)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
      ...
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L80 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L80
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    ;; RTRN
  ...
  (func $fn_L81 (export "fn_L81") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6)) ;; STORE slot 6
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L83
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 8))) ;; LF L74
    ...
    (local.set $t6 (local.get $t8))
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L83 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L83
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
  ...
  (func $fn_L85 (export "fn_L85") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9)) ;; STORE slot 9
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10)) ;; STORE slot 10
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L88
    ...
    (local.set $t18 (i32.add (global.get $TB) (i32.const 7))) ;; LF L66
    ...
    (local.set $t9 (local.get $t11))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    )) ;; end block / LAB L88 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L88
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
  ...
  (func $fn_L90 (export "fn_L90") (type $bcpl_fn)
    ...
    (if (i32.gt_s (local.get $t9) (local.get $t10)) (then
      ...
      (local.set $__lab (i32.const 1)) (br $__dispatch)
    )) ;; end block / LAB L91 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L91
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (local.get $t10) (local.get $t11)))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L94 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L94
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.const 1))
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t9))
  ...
  (func $fn_L95 (export "fn_L95") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6)) ;; STORE slot 6
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L97
    ...
    (local.set $t15 (i32.add (global.get $TB) (i32.const 12))) ;; LF L90
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
  ...
  (func $fn_L99 (export "fn_L99") (type $bcpl_fn)
    ...
    (if (local.get $t9) (then
      ...
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L103
    ...
    (local.set $t3 (local.get $t9))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    )) ;; end block / LAB L103 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L103
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t10 (i32.const 0))
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
  ...
  (func $fn_L104 (export "fn_L104") (type $bcpl_fn)
    ...
    (local.set $t8 (i32.add (global.get $TB) (i32.const 14))) ;; LF L99
  ...
  (func $fn_L105 (export "fn_L105") (type $bcpl_fn)
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 14))) ;; LF L99
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 15))) ;; LF L104
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t14)) ;; entry fn_idx
  ...
  (func $fn_L112 (export "fn_L112") (type $bcpl_fn)
    ...
    (local.set $t8 (i32.add (local.get $t8) (local.get $t9)))
    (local.set $t9 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (i32.const 0)) ;; return addr placeholder
  ...
  (func $fn_L117 (export "fn_L117") (type $bcpl_fn)
    ...
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t10 (i32.add (local.get $t10) (local.get $t11)))
    (local.set $t11 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    ...
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t11 (i32.add (local.get $t11) (local.get $t12)))
    (local.set $t12 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t12 (i32.add (local.get $t12) (local.get $t13)))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t14 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (i32.const 0)) ;; return addr placeholder
  ...
  ;; BCPL fn point_in_subsector (L119)
  (func $fn_L119 (export "fn_L119") (type $bcpl_fn)
    ...
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 23))) ;; LF L117
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (global.get $P)) ;; save P
    ...
    (local.set $t12 (i32.add (local.get $t12) (local.get $t13)))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t5 (local.get $t8))
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L124
    )) ;; end block / LAB L122 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L122
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    ...
    (if (local.get $t6) (then
      ...
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L125 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L125
  ...
  (func $fn_L126 (export "fn_L126") (type $bcpl_fn)
    ...
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (global.get $TB) (i32.const 24))) ;; LF L119
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t11 (i32.add (local.get $t11) (local.get $t12)))
    (local.set $t12 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t13 (i32.add (local.get $t13) (local.get $t14)))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t15 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t17 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t20 (i32.add (global.get $TB) (i32.const 18))) ;; LF L112
    ...
    (local.set $t17 (i32.add (global.get $TB) (i32.const 20))) ;; LF L114
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16))
  ...
  ;; BCPL fn find_player_start (L130)
  (func $fn_L130 (export "fn_L130") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8)) ;; STORE slot 8
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L132
    ...
    (local.set $t16 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    ...
    (return (local.get $__res))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L133 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L133
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.const 1))
    (local.set $t9 (i32.add (local.get $t9) (local.get $t10)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t9))
  ...
  (func $fn_L134 (export "fn_L134") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (local.get $t3)) ;; flush t3 (pre-stack-up)
      (local.set $__lab (i32.const 9)) (br $__dispatch) ;; JUMP L136
    )) ;; end block / LAB L135 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L135
    (local.set $t12 (i32.const 0))
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t12 (i32.add (local.get $t12) (local.get $t13)))
    ...
    (i32.store
      ...
      (local.get $t14))
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L139
    )) ;; end block / LAB L141 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L141
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L139
    )) ;; end block / LAB L137 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L137
    ...
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L143
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L142 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L142
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L139 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L139
    ...
    (i32.store
      ...
      (local.get $t14))
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L144 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L144
      (local.set $__lab (i32.const 9)) (br $__dispatch)
  ...
  (func $fn_L147 (export "fn_L147") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (local.get $t4)) ;; STORE slot 4
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L149
    )) ;; end block / LAB L148 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L148
    ...
    (local.set $t4 (local.get $t6))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L149 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L149
    (local.set $t6 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t7 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (if (i32.le_s (local.get $t6) (local.get $t7)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
  ...
  (func $fn_L150 (export "fn_L150") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6)) ;; STORE slot 6
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L152
    ...
    (local.set $t12 (i32.mul (local.get $t12) (local.get $t13)))
    (local.set $t11 (i32.add (local.get $t11) (local.get $t12)))
    (local.set $t12 (i32.add (global.get $TB) (i32.const 4))) ;; LF L62
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t16 (i32.add (global.get $TB) (i32.const 12))) ;; LF L90
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L153 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L153
    (local.set $t7 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t8 (i32.const 1))
    (local.set $t7 (i32.add (local.get $t7) (local.get $t8)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t7))
  ...
  (func $fn_L154 (export "fn_L154") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6)) ;; STORE slot 6
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L156
    )) ;; end block / LAB L155 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L155
    (local.set $t7 (i32.const 2))
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t7 (i32.mul (local.get $t7) (local.get $t8)))
    ...
    (local.set $t5 (local.get $t7))
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L156 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L156
    (local.set $t7 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (if (i32.le_s (local.get $t7) (local.get $t8)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
  ...
  ;; BCPL fn stamp_patch_column (L159)
  (func $fn_L159 (export "fn_L159") (type $bcpl_fn)
    ...
    (local.set $t15 (i32.add (local.get $t15) (local.get $t16)))
    (local.set $t16 (i32.add (global.get $TB) (i32.const 4))) ;; LF L62
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L160 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L160
    ...
    (if (i32.eq  (local.get $t16) (local.get $t17)) (then
      ...
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L162 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L162
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t17 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56))))
    (local.set $t18 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (local.set $t17 (i32.add (local.get $t17) (local.get $t18)))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t18)) ;; STORE slot 18
      (local.set $__lab (i32.const 6)) (br $__dispatch) ;; JUMP L165
    )) ;; end block / LAB L164 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L164
    ...
    (local.set $t29 (i32.add (global.get $TB) (i32.const 32))) ;; LF L158
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t29)))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L166 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L166
    ...
    (local.set $t17 (local.get $t19))
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L165 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L165
    (local.set $t19 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    ...
    (if (i32.ne  (local.get $t16) (local.get $t17)) (then
      ...
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L163 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L163
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    ;; RTRN
  ...
  ;; BCPL fn composite_texture (L167)
  (func $fn_L167 (export "fn_L167") (type $bcpl_fn)
    ...
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (global.get $TB) (i32.const 30))) ;; LF L150
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L169 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L169
    (local.set $t14 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t15 (i32.const 12))
    (local.set $t16 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t15 (i32.add (local.get $t15) (local.get $t16)))
    (local.set $t16 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L172 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L172
    (local.set $t11 (i32.const 0))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t12 (i32.mul (local.get $t12) (local.get $t13)))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11)) ;; STORE slot 11
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12)) ;; STORE slot 12
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L174
    )) ;; end block / LAB L173 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L173
    (local.set $t13 (i32.const 0))
    ...
    (local.set $t11 (local.get $t13))
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L174 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L174
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11)) ;; STORE slot 11
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12)) ;; STORE slot 12
      (local.set $__lab (i32.const 12)) (br $__dispatch) ;; JUMP L176
    )) ;; end block / LAB L175 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L175
    ...
    (local.set $t18 (i32.add (local.get $t18) (local.get $t19)))
    (local.set $t19 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (local.get $t17))
    ...
    (local.set $t19 (i32.add (local.get $t19) (local.get $t20)))
    (local.set $t20 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t18))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    ...
    (local.set $t20 (i32.add (local.get $t20) (local.get $t21)))
    (local.set $t21 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    ...
    (local.set $t23 (i32.add (global.get $TB) (i32.const 13))) ;; LF L95
    ...
    (local.set $t27 (i32.add (global.get $TB) (i32.const 4))) ;; LF L62
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 100)) (local.get $t25))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104)) (local.get $t26))
    ...
    (local.set $t26 (i32.add (local.get $t26) (local.get $t27)))
    (local.set $t27 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 100)) (local.get $t25))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104)) (local.get $t26))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (i32.const 0)) ;; return addr placeholder
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (local.get $t23)) ;; STORE slot 23
      (local.set $__lab (i32.const 10)) (br $__dispatch) ;; JUMP L179
    )) ;; end block / LAB L178 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L178
    (local.set $t27 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    ...
    (local.set $t34 (i32.add (global.get $TB) (i32.const 33))) ;; LF L159
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108)) (local.get $t27))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (local.get $t28))
    ...
    )) ;; end block / LAB L179 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L179
    (local.set $t24 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88))))
    ...
    (if (i32.le_s (local.get $t24) (local.get $t25)) (then
      ...
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L177 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L177
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t14 (i32.const 1))
    (local.set $t13 (i32.add (local.get $t13) (local.get $t14)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t13))
    ...
    )) ;; end block / LAB L176 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L176
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (if (i32.le_s (local.get $t13) (local.get $t14)) (then
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    ...
    )) ;; end block / LAB L180 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L180
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t15 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t14 (i32.add (local.get $t14) (local.get $t15)))
    ...
    (if (i32.le_s (local.get $t13) (local.get $t14)) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L181 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L181
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t12 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 21)) (i32.const 2)))) ;; LL L31
  ...
  ;; BCPL fn ensure_sidedef_tex (L182)
  (func $fn_L182 (export "fn_L182") (type $bcpl_fn)
    ...
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 31))) ;; LF L154
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L185 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L185
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 34))) ;; LF L167
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
  ...
  ;; BCPL fn prebuild_textures (L186)
  (func $fn_L186 (export "fn_L186") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (local.get $t4)) ;; STORE slot 4
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L188
    )) ;; end block / LAB L187 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L187
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.const 4))
    (local.set $t11 (i32.add (global.get $TB) (i32.const 35))) ;; LF L182
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t7 (i32.add (global.get $SB) (i32.const 39))) ;; LSTR
  ...
  ;; BCPL fn cam_x (L189)
  (func $fn_L189 (export "fn_L189") (type $bcpl_fn)
    (local $__lab i32)
    (local $__res i32)
    (local $t0 i32)
    (local $t1 i32)
  ...
  (func $fn_L195 (export "fn_L195") (type $bcpl_fn)
    ...
    (if (i32.le_s (local.get $t5) (local.get $t6)) (then
      ...
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L197 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L197
  ...
  ;; BCPL fn draw_textured_band (L206)
  (func $fn_L206 (export "fn_L206") (type $bcpl_fn)
    ...
    (local.set $t18 (i32.add (global.get $TB) (i32.const 43))) ;; LF L200
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (local.get $t17))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L207 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L207
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L210 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L210
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    ;; RTRN
  ...
  (func $fn_L211 (export "fn_L211") (type $bcpl_fn)
    ...
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 0))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t53)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 48)))
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (local.get $t48))
    (local.set $t4 (local.get $t48))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 2))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t48))
    (local.set $t5 (local.get $t48))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 6))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t48))
    (local.set $t6 (local.get $t48))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 8))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t48))
    (local.set $t7 (local.get $t48))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 10))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t48))
    (local.set $t8 (local.get $t48))
    (local.set $t48 (i32.const 14))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 9)) (i32.const 2)))) ;; LL L19
    (local.set $t48 (i32.add (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t48))
    (local.set $t9 (local.get $t48))
    (local.set $t48 (i32.const 0))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (if (i32.ne  (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
    ))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 10))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t48))
    (local.set $t10 (local.get $t48))
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 12))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t48))
    (local.set $t11 (local.get $t48))
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L214
    )) ;; end block / LAB L212 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L212
    (local.set $t51 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t52 (i32.const 12))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t52 (i32.add (local.get $t52) (local.get $t53)))
    ...
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t49 (i32.const 0))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    ))
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    ...
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 18))) ;; LF L112
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 48)))
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t48))
    (local.set $t12 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (local.set $t49 (i32.const 0))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    ))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L216 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L216
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 20))) ;; LF L114
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88)) (local.get $t48))
    (local.set $t22 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 21))) ;; LF L115
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (local.get $t48))
    (local.set $t23 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 22))) ;; LF L116
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96)) (local.get $t48))
    (local.set $t24 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 19))) ;; LF L113
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
    (local.set $t48 (i32.add (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 176)) (local.get $t48))
    (local.set $t44 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t49 (i32.const 0))
    (local.set $t48 (i32.sub (i32.const 0) (i32.ge_s (local.get $t48) (local.get $t49))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108)) (local.get $t48))
    (local.set $t27 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108))))
    (if (i32.eqz (local.get $t48)) (then
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    ))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t48))
    (local.set $t13 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52))))
    (local.set $t49 (i32.const 0))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    ))
    ...
    (local.set $t27 (local.get $t48))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L218 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L218
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108))))
    (if (i32.eqz (local.get $t48)) (then
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    ))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 20))) ;; LF L114
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 100)) (local.get $t48))
    (local.set $t25 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 21))) ;; LF L115
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104)) (local.get $t48))
    (local.set $t26 (local.get $t48))
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L219 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L219
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L217 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L217
    (local.set $t48 (i32.const 4))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 8)) (i32.const 2)))) ;; LL L18
    (local.set $t48 (i32.add (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (local.set $t49 (i32.const 4))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 8)) (i32.const 2)))) ;; LL L18
    (local.set $t49 (i32.add (local.get $t49) (local.get $t50)))
    ...
    (local.set $t55 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t54 (i32.add (local.get $t54) (local.get $t55)))
    (local.set $t55 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t50))
    (local.set $t14 (local.get $t50))
    (local.set $t53 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    ...
    (local.set $t50 (call_indirect $ftable (type $bcpl_fn) (local.get $t55)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t50)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t50))
    (local.set $t15 (local.get $t50))
    (local.set $t53 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t54 (i32.const 0))
    (local.set $t55 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196))))
    (local.set $t54 (i32.add (local.get $t54) (local.get $t55)))
    (local.set $t55 (i32.add (global.get $TB) (i32.const 6))) ;; LF L64
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212)) (local.get $t53))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216)) (local.get $t54))
    ...
    (local.set $t50 (call_indirect $ftable (type $bcpl_fn) (local.get $t55)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t50)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t50))
    (local.set $t16 (local.get $t50))
    (local.set $t53 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t54 (i32.const 2))
    (local.set $t55 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196))))
    (local.set $t54 (i32.add (local.get $t54) (local.get $t55)))
    ...
    (local.set $t50 (call_indirect $ftable (type $bcpl_fn) (local.get $t55)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t50)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (local.get $t50))
    (local.set $t17 (local.get $t50))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108))))
    (if (local.get $t48) (then
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    ))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60))))
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    (local.set $t54 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    (local.set $t55 (i32.add (global.get $TB) (i32.const 39))) ;; LF L191
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212)) (local.get $t53))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216)) (local.get $t54))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t55)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 48)))
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t55)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (if (local.get $t48) (then
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    ))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L221 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L221
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L220 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L220
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56))))
    (local.set $t48 (i32.sub (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (local.get $t49)) ;; STORE slot 49
    (local.set $t53 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t54 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t53 (i32.mul (local.get $t53) (local.get $t54)))
    (local.set $t54 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196))))
    (local.set $t55 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196))))
    (local.set $t54 (i32.mul (local.get $t54) (local.get $t55)))
    (local.set $t53 (i32.add (local.get $t53) (local.get $t54)))
    (local.set $t54 (i32.add (global.get $TB) (i32.const 17))) ;; LF L108
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212)) (local.get $t53))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (i32.const 0)) ;; return addr placeholder
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t50)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 152)) (local.get $t50))
    (local.set $t38 (local.get $t50))
    (local.set $t48 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156)) (local.get $t48))
    (local.set $t39 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 152))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160)) (local.get $t48))
    (local.set $t40 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60))))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 37))) ;; LF L189
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t48))
    (local.set $t18 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60))))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 38))) ;; LF L190
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t48))
    (local.set $t19 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 37))) ;; LF L189
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t48))
    (local.set $t20 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 38))) ;; LF L190
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t48))
    (local.set $t21 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t49 (i32.const 4))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 10)) (br $__dispatch)
    ))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84))))
    (local.set $t49 (i32.const 4))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 10)) (br $__dispatch)
    ))
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L222 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L222
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t49 (i32.const 4))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    ...
    (local.set $t48 (i32.const 4))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t48 (i32.sub (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.const 1024))
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t48 (i32.div_s (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.const 1024))
    (local.set $t49 (i32.div_s (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72))))
    (local.set $t49 (i32.add (local.get $t49) (local.get $t50)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t49))
    (local.set $t18 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.const 1024))
    ...
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156))))
    (local.set $t49 (i32.add (local.get $t49) (local.get $t50)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156)) (local.get $t49))
    (local.set $t39 (local.get $t49))
    (local.set $t49 (i32.const 4))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t49))
    (local.set $t19 (local.get $t49))
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L223 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L223
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84))))
    (local.set $t49 (i32.const 4))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 12)) (br $__dispatch)
    ...
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t48 (i32.div_s (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.const 1024))
    ...
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (local.set $t49 (i32.add (local.get $t49) (local.get $t50)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t49))
    (local.set $t20 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156))))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160))))
    (local.set $t49 (i32.sub (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.const 1024))
    ...
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160))))
    (local.set $t49 (i32.add (local.get $t49) (local.get $t50)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160)) (local.get $t49))
    (local.set $t40 (local.get $t49))
    (local.set $t49 (i32.const 4))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t49))
    (local.set $t21 (local.get $t49))
      (local.set $__lab (i32.const 12)) (br $__dispatch)
    )) ;; end block / LAB L224 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L224
    (local.set $t48 (i32.const 480))
    (local.set $t49 (i32.const 480))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t49 (i32.div_s (local.get $t49) (local.get $t50)))
    (local.set $t48 (i32.add (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (local.get $t48))
    (local.set $t28 (local.get $t48))
    (local.set $t48 (i32.const 480))
    (local.set $t49 (i32.const 480))
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (local.set $t49 (i32.mul (local.get $t49) (local.get $t50)))
    ...
    (local.set $t49 (i32.div_s (local.get $t49) (local.get $t50)))
    (local.set $t48 (i32.add (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (local.get $t48))
    (local.set $t29 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (if (i32.le_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 13)) (br $__dispatch)
    ))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (local.get $t49))
    (local.set $t28 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (local.get $t49))
    (local.set $t29 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t49))
    (local.set $t48 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (local.get $t49))
    (local.set $t18 (local.get $t49))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    ...
    (local.set $t40 (local.get $t49))
      (local.set $__lab (i32.const 13)) (br $__dispatch)
    )) ;; end block / LAB L225 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L225
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (if (i32.ne  (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    ))
    ;; RTRN
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L226 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L226
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (local.get $t48))
    (local.set $t30 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t48))
    (local.set $t31 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120))))
    (local.set $t49 (i32.const 0))
    (if (i32.ge_s (local.get $t48) (local.get $t49)) (then
    ...
    (local.set $t30 (local.get $t48))
      (local.set $__lab (i32.const 15)) (br $__dispatch)
    )) ;; end block / LAB L227 = idx 15
    (if (i32.eq (local.get $__lab) (i32.const 15)) (then ;; L227
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124))))
    (local.set $t49 (i32.const 960))
    (if (i32.lt_s (local.get $t48) (local.get $t49)) (then
      (local.set $__lab (i32.const 16)) (br $__dispatch)
    ))
    (local.set $t48 (i32.const 959))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t48))
    (local.set $t31 (local.get $t48))
      (local.set $__lab (i32.const 16)) (br $__dispatch)
    )) ;; end block / LAB L228 = idx 16
    (if (i32.eq (local.get $__lab) (i32.const 16)) (then ;; L228
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124))))
    (if (i32.le_s (local.get $t48) (local.get $t49)) (then
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L229 = idx 17
    (if (i32.eq (local.get $__lab) (i32.const 17)) (then ;; L229
    (local.set $t48 (i32.const 1048576))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76))))
    (local.set $t48 (i32.div_s (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t48))
    (local.set $t32 (local.get $t48))
    (local.set $t48 (i32.const 1048576))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84))))
    (local.set $t48 (i32.div_s (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t48))
    (local.set $t33 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (local.set $t48 (i32.sub (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136)) (local.get $t48))
    (local.set $t34 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 156))))
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 164)) (local.get $t48))
    (local.set $t41 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 160))))
    (local.set $t48 (i32.mul (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 168)) (local.get $t48))
    (local.set $t42 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 168))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 164))))
    (local.set $t48 (i32.sub (local.get $t48) (local.get $t49)))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136))))
    (local.set $t48 (i32.div_s (local.get $t48) (local.get $t49)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 172)) (local.get $t48))
    (local.set $t43 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96))))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 40))) ;; LF L192
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 200)) (local.get $t52)) ;; entry fn_idx
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 140)) (local.get $t48))
    (local.set $t35 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96))))
    (local.set $t52 (i32.const 16))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 144)) (local.get $t48))
    (local.set $t36 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96))))
    (local.set $t52 (i32.const 32))
    (local.set $t51 (i32.sub (local.get $t51) (local.get $t52)))
    (local.set $t52 (i32.add (global.get $TB) (i32.const 40))) ;; LF L192
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t52)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 148)) (local.get $t48))
    (local.set $t37 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t52 (i32.const 20))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 35))) ;; LF L182
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 180)) (local.get $t48))
    (local.set $t45 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t52 (i32.const 12))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 35))) ;; LF L182
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 184)) (local.get $t48))
    (local.set $t46 (local.get $t48))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40))))
    (local.set $t52 (i32.const 4))
    (local.set $t53 (i32.add (global.get $TB) (i32.const 35))) ;; LF L182
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204)) (local.get $t51))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t52))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (global.get $P)) ;; save P
    ...
    (local.set $t48 (call_indirect $ftable (type $bcpl_fn) (local.get $t53)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 188)) (local.get $t48))
    (local.set $t47 (local.get $t48))
    (local.set $t48 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120))))
    (local.set $t49 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t48)) ;; STORE slot 48
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196)) (local.get $t49)) ;; STORE slot 49
      (local.set $__lab (i32.const 35)) (br $__dispatch) ;; JUMP L231
    )) ;; end block / LAB L230 = idx 18
    (if (i32.eq (local.get $__lab) (i32.const 18)) (then ;; L230
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    ...
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136))))
    ...
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132))))
    (local.set $t52 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128))))
    (local.set $t51 (i32.sub (local.get $t51) (local.get $t52)))
    ...
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204))))
    (local.set $t61 (i32.const 0))
    (if (i32.le_s (local.get $t60) (local.get $t61)) (then
      (local.set $__lab (i32.const 34)) (br $__dispatch)
    ))
    (local.set $t60 (i32.const 1048576))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204))))
    (local.set $t60 (i32.div_s (local.get $t60) (local.get $t61)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208)) (local.get $t60))
    (local.set $t52 (local.get $t60))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t65 (i32.add (global.get $TB) (i32.const 44))) ;; LF L205
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248)) (local.get $t65)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 60)))
    (local.set $t60 (call_indirect $ftable (type $bcpl_fn) (local.get $t65)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (local.get $t60)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212)) (local.get $t60))
    (local.set $t53 (local.get $t60))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t65 (i32.add (global.get $TB) (i32.const 44))) ;; LF L205
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    ...
    (local.set $t60 (call_indirect $ftable (type $bcpl_fn) (local.get $t65)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (local.get $t60)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216)) (local.get $t60))
    (local.set $t54 (local.get $t60))
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    ...
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t62 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 27)) (i32.const 2)))) ;; LL L37
    (local.set $t61 (i32.add (local.get $t61) (local.get $t62)))
    (local.set $t61 (i32.load (i32.shl (local.get $t61) (i32.const 2))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244)) (local.get $t61)) ;; STORE slot 61
    (local.set $t62 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240))))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (if (i32.ge_s (local.get $t62) (local.get $t63)) (then
      (local.set $__lab (i32.const 21)) (br $__dispatch)
    ))
    (local.set $t62 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    ...
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244))))
    (if (i32.le_s (local.get $t63) (local.get $t64)) (then
      (local.set $__lab (i32.const 19)) (br $__dispatch)
    ))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248)) (local.get $t63))
    (local.set $t62 (local.get $t63))
      (local.set $__lab (i32.const 19)) (br $__dispatch)
    )) ;; end block / LAB L234 = idx 19
    (if (i32.eq (local.get $__lab) (i32.const 19)) (then ;; L234
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (if (i32.gt_s (local.get $t63) (local.get $t64)) (then
      (local.set $__lab (i32.const 20)) (br $__dispatch)
    ))
    (local.set $t66 (i32.const 66))
    (local.set $t67 (i32.const 29))
    (local.set $t68 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L10
    (local.set $t69 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t70 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240))))
    (local.set $t71 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (local.set $t72 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 29)) (i32.const 2)))) ;; LL L39
    (local.set $t73 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 264)) (local.get $t66))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 268)) (local.get $t67))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 272)) (local.get $t68))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 260)) (local.get $t73)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 63)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t73)))
      (local.set $__lab (i32.const 20)) (br $__dispatch)
    )) ;; end block / LAB L235 = idx 20
    (if (i32.eq (local.get $__lab) (i32.const 20)) (then ;; L235
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t65 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t64 (i32.add (local.get $t64) (local.get $t65)))
    (i32.store (i32.shl (local.get $t64) (i32.const 2)) (local.get $t63))
      (local.set $__lab (i32.const 21)) (br $__dispatch)
    )) ;; end block / LAB L233 = idx 21
    (if (i32.eq (local.get $__lab) (i32.const 21)) (then ;; L233
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (local.set $t60 (i32.load (i32.shl (local.get $t60) (i32.const 2))))
    ...
    (local.set $t61 (i32.load (i32.shl (local.get $t61) (i32.const 2))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244)) (local.get $t61)) ;; STORE slot 61
    (local.set $t62 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244))))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216))))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248)) (local.get $t62)) ;; STORE slot 62
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240))))
    (if (i32.ge_s (local.get $t63) (local.get $t64)) (then
    ...
    (local.set $t62 (local.get $t63))
      (local.set $__lab (i32.const 22)) (br $__dispatch)
    )) ;; end block / LAB L237 = idx 22
    (if (i32.eq (local.get $__lab) (i32.const 22)) (then ;; L237
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244))))
    (if (i32.gt_s (local.get $t63) (local.get $t64)) (then
    ...
    (local.set $t68 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L10
    (local.set $t69 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t70 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248))))
    (local.set $t71 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244))))
    (local.set $t72 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 30)) (i32.const 2)))) ;; LL L40
    (local.set $t73 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 264)) (local.get $t66))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 268)) (local.get $t67))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 272)) (local.get $t68))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t73)))
      (local.set $__lab (i32.const 23)) (br $__dispatch)
    )) ;; end block / LAB L238 = idx 23
    (if (i32.eq (local.get $__lab) (i32.const 23)) (then ;; L238
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t65 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 27)) (i32.const 2)))) ;; LL L37
    (local.set $t64 (i32.add (local.get $t64) (local.get $t65)))
    (i32.store (i32.shl (local.get $t64) (i32.const 2)) (local.get $t63))
      (local.set $__lab (i32.const 24)) (br $__dispatch)
    )) ;; end block / LAB L236 = idx 24
    (if (i32.eq (local.get $__lab) (i32.const 24)) (then ;; L236
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (local.set $t60 (i32.load (i32.shl (local.get $t60) (i32.const 2))))
    ...
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t64 (i32.add (global.get $TB) (i32.const 42))) ;; LF L198
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248)) (local.get $t64)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 60)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t64)))
      (local.set $__lab (i32.const 34)) (br $__dispatch) ;; JUMP L232
    )) ;; end block / LAB L239 = idx 25
    (if (i32.eq (local.get $__lab) (i32.const 25)) (then ;; L239
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    (local.set $t60 (i32.sub (local.get $t60) (local.get $t61)))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 172))))
    (local.set $t60 (i32.mul (local.get $t60) (local.get $t61)))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 164))))
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 228)) (local.get $t60))
    (local.set $t57 (local.get $t60))
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 228))))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 204))))
    (local.set $t60 (i32.div_s (local.get $t60) (local.get $t61)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 232)) (local.get $t60))
    (local.set $t58 (local.get $t60))
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 176))))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 232))))
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 236)) (local.get $t60))
    (local.set $t59 (local.get $t60))
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 108))))
    (if (i32.eqz (local.get $t60)) (then
      (local.set $__lab (i32.const 32)) (br $__dispatch)
    ))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t65 (i32.add (global.get $TB) (i32.const 44))) ;; LF L205
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    ...
    (local.set $t60 (call_indirect $ftable (type $bcpl_fn) (local.get $t65)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (local.get $t60)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 224)) (local.get $t60))
    (local.set $t56 (local.get $t60))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 100))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t65 (i32.add (global.get $TB) (i32.const 44))) ;; LF L205
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    ...
    (local.set $t60 (call_indirect $ftable (type $bcpl_fn) (local.get $t65)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (local.get $t60)) ;; flush FNAP result
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 220)) (local.get $t60))
    (local.set $t55 (local.get $t60))
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104))))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92))))
    (if (i32.ge_s (local.get $t60) (local.get $t61)) (then
      (local.set $__lab (i32.const 28)) (br $__dispatch)
    ))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (local.set $t65 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 224))))
    (local.set $t66 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (local.set $t67 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t68 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 236))))
    (local.set $t69 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 188))))
    (local.set $t70 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 148))))
    (local.set $t71 (i32.add (global.get $TB) (i32.const 45))) ;; LF L206
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 260)) (local.get $t65))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 264)) (local.get $t66))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 268)) (local.get $t67))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 272)) (local.get $t68))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 276)) (local.get $t69))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 240)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 244)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 248)) (local.get $t71)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 60)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t71)))
    (local.set $t60 (i32.const 1))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 224))))
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t62 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t61 (i32.add (local.get $t61) (local.get $t62)))
    (local.set $t61 (i32.load (i32.shl (local.get $t61) (i32.const 2))))
    (if (i32.le_s (local.get $t60) (local.get $t61)) (then
    ...
    (local.set $t62 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t61 (i32.add (local.get $t61) (local.get $t62)))
    (i32.store (i32.shl (local.get $t61) (i32.const 2)) (local.get $t60))
      (local.set $__lab (i32.const 26)) (br $__dispatch)
    )) ;; end block / LAB L244 = idx 26
    (if (i32.eq (local.get $__lab) (i32.const 26)) (then ;; L244
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (local.set $t60 (i32.load (i32.shl (local.get $t60) (i32.const 2))))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t64)))
      (local.set $__lab (i32.const 27)) (br $__dispatch)
    )) ;; end block / LAB L245 = idx 27
    (if (i32.eq (local.get $__lab) (i32.const 27)) (then ;; L245
      (local.set $__lab (i32.const 28)) (br $__dispatch)
    )) ;; end block / LAB L243 = idx 28
    (if (i32.eq (local.get $__lab) (i32.const 28)) (then ;; L243
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 100))))
    (local.set $t61 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88))))
    (if (i32.le_s (local.get $t60) (local.get $t61)) (then
      (local.set $__lab (i32.const 31)) (br $__dispatch)
    ))
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 220))))
    (local.set $t65 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216))))
    (local.set $t66 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 220))))
    (local.set $t67 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t68 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 236))))
    (local.set $t69 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 184))))
    (local.set $t70 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 144))))
    (local.set $t71 (i32.add (global.get $TB) (i32.const 45))) ;; LF L206
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 260)) (local.get $t65))
    ...
    (i32.store (i32.shl (local.get $t61) (i32.const 2)) (local.get $t60))
      (local.set $__lab (i32.const 29)) (br $__dispatch)
    )) ;; end block / LAB L247 = idx 29
    (if (i32.eq (local.get $__lab) (i32.const 29)) (then ;; L247
    (local.set $t60 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t61 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t60 (i32.add (local.get $t60) (local.get $t61)))
    (local.set $t60 (i32.load (i32.shl (local.get $t60) (i32.const 2))))
    ...
    (global.set $P (i32.add (global.get $P) (i32.const 60)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t64)))
      (local.set $__lab (i32.const 33)) (br $__dispatch) ;; JUMP L242
    )) ;; end block / LAB L248 = idx 30
    (if (i32.eq (local.get $__lab) (i32.const 30)) (then ;; L248
      (local.set $__lab (i32.const 33)) (br $__dispatch) ;; JUMP L242
    )) ;; end block / LAB L246 = idx 31
    (if (i32.eq (local.get $__lab) (i32.const 31)) (then ;; L246
      (local.set $__lab (i32.const 33)) (br $__dispatch) ;; JUMP L242
    )) ;; end block / LAB L240 = idx 32
    (if (i32.eq (local.get $__lab) (i32.const 32)) (then ;; L240
    (local.set $t63 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t64 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (local.set $t65 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 216))))
    (local.set $t66 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 212))))
    (local.set $t67 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 208))))
    (local.set $t68 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 236))))
    (local.set $t69 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 180))))
    (local.set $t70 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 140))))
    (local.set $t71 (i32.add (global.get $TB) (i32.const 45))) ;; LF L206
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 252)) (local.get $t63))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 256)) (local.get $t64))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 260)) (local.get $t65))
    ...
    )) ;; end block / LAB L242 = idx 33
    (if (i32.eq (local.get $__lab) (i32.const 33)) (then ;; L242
      (local.set $__lab (i32.const 34)) (br $__dispatch)
    )) ;; end block / LAB L232 = idx 34
    (if (i32.eq (local.get $__lab) (i32.const 34)) (then ;; L232
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t51 (i32.const 1))
    (local.set $t50 (i32.add (local.get $t50) (local.get $t51)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192)) (local.get $t50))
    (local.set $t48 (local.get $t50))
      (local.set $__lab (i32.const 35)) (br $__dispatch)
    )) ;; end block / LAB L231 = idx 35
    (if (i32.eq (local.get $__lab) (i32.const 35)) (then ;; L231
    (local.set $t50 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 192))))
    (local.set $t51 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 196))))
  ...
  ;; BCPL fn render_subsector (L249)
  (func $fn_L249 (export "fn_L249") (type $bcpl_fn)
    (local $__lab i32)
    (local $__res i32)
    (local $t0 i32)
    (local $t1 i32)
    ...
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t10 (i32.add (local.get $t10) (local.get $t11)))
    (local.set $t11 (i32.add (global.get $TB) (i32.const 5))) ;; LF L63
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (i32.const 0)) ;; return addr placeholder
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8)) ;; STORE slot 8
      (local.set $__lab (i32.const 3)) (br $__dispatch) ;; JUMP L251
    )) ;; end block / LAB L250 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L250
    ...
    (local.set $t12 (i32.add (local.get $t12) (local.get $t13)))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 46))) ;; LF L211
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t7 (local.get $t9))
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L251 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L251
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
    (if (i32.le_s (local.get $t9) (local.get $t10)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
  ...
  ;; BCPL fn render_node (L253)
  (func $fn_L253 (export "fn_L253") (type $bcpl_fn)
    (local $__lab i32)
    (local $__res i32)
    (local $t0 i32)
    (local $t1 i32)
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L254 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L254
    ...
    (local.set $t8 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t7 (i32.and (local.get $t7) (local.get $t8)))
    (local.set $t8 (i32.add (global.get $TB) (i32.const 47))) ;; LF L249
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t8)) ;; entry fn_idx
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L255 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L255
    ...
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t11 (i32.add (global.get $TB) (i32.const 23))) ;; LF L117
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (global.get $P)) ;; save P
    ...
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t12 (i32.add (global.get $TB) (i32.const 48))) ;; LF L253
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t12)) ;; entry fn_idx
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L256 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L256
    (local.set $t11 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t12 (i32.add (global.get $TB) (i32.const 48))) ;; LF L253
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
  ...
  ;; BCPL fn fill_remaining (L257)
  (func $fn_L257 (export "fn_L257") (type $bcpl_fn)
    (local $__lab i32)
    (local $__res i32)
    (local $t0 i32)
    (local $t1 i32)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (local.get $t3)) ;; STORE slot 3
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (local.get $t4)) ;; STORE slot 4
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L259
    )) ;; end block / LAB L258 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L258
    (local.set $t5 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t6 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 26)) (i32.const 2)))) ;; LL L36
    (local.set $t5 (i32.add (local.get $t5) (local.get $t6)))
    (local.set $t5 (i32.load (i32.shl (local.get $t5) (i32.const 2))))
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L262 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L262
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t18)))
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L261 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L261
    (local.set $t7 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t8 (i32.const 360))
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    )) ;; end block / LAB L264 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L264
    (local.set $t11 (i32.const 66))
    (local.set $t12 (i32.const 29))
    (local.set $t13 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L10
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t18)))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L263 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L263
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    ...
    (local.set $t3 (local.get $t5))
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L259 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L259
    (local.set $t5 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t6 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (if (i32.le_s (local.get $t5) (local.get $t6)) (then
      (local.set $__lab (i32.const 1)) (br $__dispatch)
  ...
  (func $fn_L265 (export "fn_L265") (type $bcpl_fn)
    ...
    (loop $__dispatch
    (if (i32.eqz (local.get $__lab)) (then ;; entry block
    (local.set $t6 (i32.add (global.get $TB) (i32.const 41))) ;; LF L195
    ...
    (local.set $t6 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 31)) (i32.const 2)))) ;; LL L41
    (local.set $t7 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 32)) (i32.const 2)))) ;; LL L42
    (local.set $t8 (i32.add (global.get $TB) (i32.const 25))) ;; LF L126
    ...
    (local.set $t7 (i32.add (global.get $TB) (i32.const 48))) ;; LF L253
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (local.get $t6))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t6 (i32.add (global.get $TB) (i32.const 49))) ;; LF L257
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t6)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 3)))
  ...
  (func $fn_L266 (export "fn_L266") (type $bcpl_fn)
    ...
    (local.set $t32 (i32.add (global.get $TB) (i32.const 3))) ;; LF L52
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    ...
    (local.set $t31 (i32.add (global.get $SB) (i32.const 47))) ;; LSTR
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L267 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L267
    (local.set $t28 (i32.const 0))
    ...
    (local.set $t31 (i32.add (global.get $SB) (i32.const 53))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L268 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L268
    ...
    (local.set $t33 (i32.add (global.get $TB) (i32.const 4))) ;; LF L62
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t34 (i32.add (global.get $TB) (i32.const 10))) ;; LF L81
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    ...
    (local.set $t31 (i32.add (global.get $SB) (i32.const 58))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t31 (i32.add (global.get $SB) (i32.const 62))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t33 (i32.add (global.get $TB) (i32.const 9))) ;; LF L77
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t35 (i32.add (global.get $SB) (i32.const 64))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (local.set $t33 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 7)) (i32.const 2)))) ;; LL L17
    (local.set $t35 (i32.add (global.get $SB) (i32.const 67))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (local.set $t33 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 7)) (i32.const 2)))) ;; LL L17
    (local.set $t35 (i32.add (global.get $SB) (i32.const 70))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (local.set $t33 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 7)) (i32.const 2)))) ;; LL L17
    (local.set $t35 (i32.add (global.get $SB) (i32.const 73))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (local.set $t33 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 7)) (i32.const 2)))) ;; LL L17
    (local.set $t35 (i32.add (global.get $SB) (i32.const 75))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (local.set $t33 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36))))
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 7)) (i32.const 2)))) ;; LL L17
    (local.set $t35 (i32.add (global.get $SB) (i32.const 82))) ;; LSTR
    (local.set $t36 (i32.add (global.get $TB) (i32.const 11))) ;; LF L85
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    ...
    (if (i32.ge_s (local.get $t28) (local.get $t29)) (then
      ...
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    )) ;; end block / LAB L271 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L271
    (local.set $t31 (i32.add (global.get $SB) (i32.const 84))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t31 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t32 (i32.const 0))
    (local.set $t33 (i32.add (global.get $TB) (i32.const 13))) ;; LF L95
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (local.get $t28)) ;; STORE slot 28
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (local.get $t29)) ;; STORE slot 29
      (local.set $__lab (i32.const 10)) (br $__dispatch) ;; JUMP L273
    )) ;; end block / LAB L272 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L272
    ...
    (local.set $t36 (i32.add (global.get $SB) (i32.const 89))) ;; LSTR
    (local.set $t37 (i32.add (global.get $TB) (i32.const 7))) ;; LF L66
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136)) (local.get $t34))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 140)) (local.get $t35))
    ...
    (local.set $t18 (local.get $t31))
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L274 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L274
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t35 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120))))
    (local.set $t36 (i32.add (global.get $SB) (i32.const 91))) ;; LSTR
    (local.set $t37 (i32.add (global.get $TB) (i32.const 7))) ;; LF L66
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136)) (local.get $t34))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 140)) (local.get $t35))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 144)) (local.get $t36))
    ...
    (local.set $t19 (local.get $t31))
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L275 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L275
    (local.set $t34 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t35 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120))))
    (local.set $t36 (i32.add (global.get $SB) (i32.const 93))) ;; LSTR
    (local.set $t37 (i32.add (global.get $TB) (i32.const 7))) ;; LF L66
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 136)) (local.get $t34))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 140)) (local.get $t35))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 144)) (local.get $t36))
    ...
    (local.set $t20 (local.get $t31))
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L276 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L276
    ...
    (local.set $t28 (local.get $t30))
      (local.set $__lab (i32.const 10)) (br $__dispatch)
    )) ;; end block / LAB L273 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L273
    (local.set $t30 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    ...
    (if (i32.ne  (local.get $t28) (local.get $t29)) (then
      ...
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L278 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L278
    (local.set $t31 (i32.add (global.get $SB) (i32.const 96))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L277 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L277
    (local.set $t31 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 5)) (i32.const 2)))) ;; LL L15
    (local.set $t32 (i32.const 16))
    ...
    (i32.store
      ...
      (local.get $t28))
    (local.set $t31 (i32.add (global.get $SB) (i32.const 106))) ;; LSTR
    ...
    (local.set $t32 (i32.add (global.get $TB) (i32.const 29))) ;; LF L147
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (local.get $t32)) ;; entry fn_idx
    ...
    (i32.store
      ...
      (local.get $t28))
    (local.set $t31 (i32.add (global.get $TB) (i32.const 16))) ;; LF L105
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (local.get $t31)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 28)))
    ...
    (local.set $t34 (i32.add (global.get $TB) (i32.const 26))) ;; LF L130
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t32))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    ...
    (i32.store
      ...
      (local.get $t28))
      (local.set $__lab (i32.const 13)) (br $__dispatch)
    )) ;; end block / LAB L279 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L279
    (local.set $t31 (i32.add (global.get $SB) (i32.const 124))) ;; LSTR
    ...
    (local.set $t32 (i32.add (global.get $TB) (i32.const 36))) ;; LF L186
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (local.get $t32)) ;; entry fn_idx
    ...
    (if (i32.gt_s (local.get $t30) (local.get $t31)) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L280 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L280
    (local.set $t30 (i32.const 0))
    (local.set $t31 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    ...
    (if (i32.le_s (local.get $t30) (local.get $t31)) (then
      ...
      (local.set $__lab (i32.const 15)) (br $__dispatch)
    )) ;; end block / LAB L281 = idx 15
    (if (i32.eq (local.get $__lab) (i32.const 15)) (then ;; L281
    (local.set $t28 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 2)) (i32.const 2)))) ;; LL L12
    (if (i32.eqz (local.get $t28)) (then
      (local.set $__lab (i32.const 27)) (br $__dispatch)
    ))
      (local.set $__lab (i32.const 16)) (br $__dispatch)
    )) ;; end block / LAB L282 = idx 16
    (if (i32.eq (local.get $__lab) (i32.const 16)) (then ;; L282
    (local.set $t28 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (local.get $t28)) ;; STORE slot 28
    (local.set $t29 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (local.get $t29)) ;; STORE slot 29
    (local.set $t33 (i32.add (global.get $TB) (i32.const 27))) ;; LF L134
    ...
    (local.set $t34 (i32.add (global.get $TB) (i32.const 28))) ;; LF L145
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 132)) (local.get $t33))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t28 (local.get $t30))
      (local.set $__lab (i32.const 18)) (br $__dispatch)
    )) ;; end block / LAB L284 = idx 18
    (if (i32.eq (local.get $__lab) (i32.const 18)) (then ;; L284
    ...
    (local.set $t28 (local.get $t30))
      (local.set $__lab (i32.const 20)) (br $__dispatch)
    )) ;; end block / LAB L286 = idx 20
    (if (i32.eq (local.get $__lab) (i32.const 20)) (then ;; L286
    ...
    (local.set $t29 (local.get $t30))
      (local.set $__lab (i32.const 22)) (br $__dispatch)
    )) ;; end block / LAB L288 = idx 22
    (if (i32.eq (local.get $__lab) (i32.const 22)) (then ;; L288
    ...
    (local.set $t29 (local.get $t30))
      (local.set $__lab (i32.const 24)) (br $__dispatch)
    )) ;; end block / LAB L290 = idx 24
    (if (i32.eq (local.get $__lab) (i32.const 24)) (then ;; L290
    (local.set $t30 (i32.const 0))
    (local.set $t31 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112))))
    ...
    (i32.store
      ...
      (local.get $t32))
      (local.set $__lab (i32.const 25)) (br $__dispatch)
    )) ;; end block / LAB L292 = idx 25
    (if (i32.eq (local.get $__lab) (i32.const 25)) (then ;; L292
    (local.set $t30 (i32.const 0))
    (local.set $t31 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116))))
    (if (i32.eq  (local.get $t30) (local.get $t31)) (then
      (local.set $__lab (i32.const 26)) (br $__dispatch)
    ...
    (i32.store
      ...
      (local.get $t30))
      (local.set $__lab (i32.const 26)) (br $__dispatch)
    )) ;; end block / LAB L293 = idx 26
    (if (i32.eq (local.get $__lab) (i32.const 26)) (then ;; L293
    (local.set $t33 (i32.add (global.get $TB) (i32.const 50))) ;; LF L265
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 120)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 128)) (local.get $t33)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 30)))
    ...
    (if (local.get $t28) (then
      ...
      (local.set $__lab (i32.const 27)) (br $__dispatch)
    )) ;; end block / LAB L283 = idx 27
    (if (i32.eq (local.get $__lab) (i32.const 27)) (then ;; L283
    ...
    (global.set $P (i32.add (global.get $P) (i32.const 28)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t32)))
    (local.set $t31 (i32.add (global.get $SB) (i32.const 133))) ;; LSTR
    (local.set $t32 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 124)) (local.get $t31))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 112)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 116)) (i32.const 0)) ;; return addr placeholder
  ...
  (elem $ftab funcref (ref.func $fn_L45) (ref.func $fn_L47) (ref.func $fn_L50) (ref.func $fn_L52) (ref.func $fn_L62) (ref.func $fn_L63) (ref.func $fn_L64) (ref.func $fn_L66) (ref.func $fn_L74) (ref.func $fn_L77) (ref.func $fn_L81) (ref.func $fn_L85) (ref.func $fn_L90) (ref.func $fn_L95) (ref.func $fn_L99) (ref.func $fn_L104) (ref.func $fn_L105) (ref.func $fn_L108) (ref.func $fn_L112) (ref.func $fn_L113) (ref.func $fn_L114) (ref.func $fn_L115) (ref.func $fn_L116) (ref.func $fn_L117) (ref.func $fn_L119) (ref.func $fn_L126) (ref.func $fn_L130) (ref.func $fn_L134) (ref.func $fn_L145) (ref.func $fn_L147) (ref.func $fn_L150) (ref.func $fn_L154) (ref.func $fn_L158) (ref.func $fn_L159) (ref.func $fn_L167) (ref.func $fn_L182) (ref.func $fn_L186) (ref.func $fn_L189) (ref.func $fn_L190) (ref.func $fn_L191) (ref.func $fn_L192) (ref.func $fn_L195) (ref.func $fn_L198) (ref.func $fn_L200) (ref.func $fn_L205) (ref.func $fn_L206) (ref.func $fn_L211) (ref.func $fn_L249) (ref.func $fn_L253) (ref.func $fn_L257) (ref.func $fn_L265) (ref.func $fn_L266))

  ;; static data — passive segment (137 words)
  (data $stat "\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\0C\6C\6F\61\64\65\64\20\57\41\44\3A\20\00\00\00\1E\63\6F\6D\70\6F\73\69\74\65\64\20\25\6E\20\75\6E\69\71\75\65\20\74\65\78\74\75\72\65\73\0A\00\17\4E\6F\20\57\41\44\20\61\73\73\65\74\20\75\70\6C\6F\61\64\65\64\2E\0A\13\41\73\73\65\74\20\69\73\20\61\6E\20\69\6D\61\67\65\2E\0A\0F\4E\6F\20\6D\61\70\20\6D\61\72\6B\65\72\2E\0A\05\6D\61\70\3A\20\00\00\08\56\45\52\54\45\58\45\53\00\00\00\08\4C\49\4E\45\44\45\46\53\00\00\00\08\53\49\44\45\44\45\46\53\00\00\00\07\53\45\43\54\4F\52\53\05\4E\4F\44\45\53\00\00\08\53\53\45\43\54\4F\52\53\00\00\00\04\53\45\47\53\00\00\00\06\54\48\49\4E\47\53\00\12\4D\69\73\73\69\6E\67\20\6D\61\70\20\6C\75\6D\70\2E\0A\00\07\50\4C\41\59\50\41\4C\06\50\4E\41\4D\45\53\00\08\54\45\58\54\55\52\45\31\00\00\00\25\4D\69\73\73\69\6E\67\20\50\4C\41\59\50\41\4C\20\2F\20\50\4E\41\4D\45\53\20\2F\20\54\45\58\54\55\52\45\31\2E\0A\00\00\30\50\4C\41\59\50\41\4C\20\40\25\6E\20\20\50\4E\41\4D\45\53\20\40\25\6E\20\28\25\6E\29\20\20\54\45\58\54\55\52\45\31\20\40\25\6E\20\28\25\6E\29\0A\00\00\00\12\4E\6F\20\70\6C\61\79\65\72\31\20\73\74\61\72\74\2E\0A\00\20\70\6C\61\79\65\72\20\73\74\61\72\74\20\20\70\78\3D\25\6E\20\70\79\3D\25\6E\20\70\61\3D\25\6E\0A\00\00\00\0C\64\77\6C\74\20\65\78\69\74\65\64\0A\00\00\00")
  ...
  (func $register (export "register")
    ...
    (table.init $ftable $ftab
      ...
      (i32.const 52))
    (elem.drop $ftab)
    (i32.store (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 4)) (i32.add (global.get $TB) (i32.const 51))) ;; G!1
  )
