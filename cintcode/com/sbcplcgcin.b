// This is the BCPL64 OCODE to Cintcode codegenerator.
...
t64 specify the bit lenth of the BCPL word in the target system. The
...
AND checkspace() BE IF stvp/wordbytelen>dp-stv DO
