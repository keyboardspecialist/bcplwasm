...
20/02/2025
Minor corrections.
Possibly avoid using OpenGL ES particularly on the
Raspberry Pi. This probably means avoiding any reference to EGL. 
...
01/05/2020
Making major modifications to this file.
...
This paragraph will be deleted eventually.
...
library with the g/gl.h header file.  Whichever version of OpenGL is used the
BCPL interface using
...
BCPLWORD glfn(BCPLWORD *args, BCPLWORD *g, BCPLWORD *W) {
  //printf("GLavail was not defined\n");
