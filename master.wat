;; BCPL-wasm master scaffolding.
;; Owns shared memory, function table, and P/G globals.
;; Places stdlib imports at fixed table slots 0..21.
;; Exports init(stack_base) — writes G[stdlib_nums] + seeds $P.
...
(module
  ...
  (func $init (export "init") (param $stack_base i32)
    ...
    (i32.store (i32.const   4) (i32.const 1000)) ;; G!0 = global vector size
    ;; G!1 is owned by programs (holds start's tidx).
