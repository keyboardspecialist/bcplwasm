// 53-doom-anim: 52 + monster animation cycling and proper sprite
// clipping through portals.
//
// What's new vs 52:
//   - Monsters cycle between frame letters A and B every ANIM_TICKS
//     frames. Falls back to A if B not in the WAD.
//   - col_z is now updated ONLY by solid-wall closures, not portal
//     segs. Lets sprites in adjacent rooms remain "in front" of the
//     portal wall's depth — they're visible through portals.
//   - Sprite per-column draw clips its y range to col_top..col_bot
//     of the column so sprites don't bleed above/below the portal
//     opening.
//
