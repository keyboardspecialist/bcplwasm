(module
  ...
  (func $fn_L16 (export "fn_L16") (type $bcpl_fn)
    ...
    (local.set $t5 (local.get $t9))
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L18
    ...
    )) ;; end block / LAB L18 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L18
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    ...
    (local.set $t9 (i32.sub (i32.const 0) (f32.gt (f32.reinterpret_i32 (local.get $t9)) (f32.reinterpret_i32 (local.get $t10)))))
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L20
    )) ;; end block / LAB L19 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L19
    ...
    )) ;; end block / LAB L20 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L20
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
  ...
  (func $fn_L21 (export "fn_L21") (type $bcpl_fn)
    ...
    (local.set $t9 (i32.add (global.get $TB) (i32.const 0))) ;; LF L16
  ...
  (func $fn_L22 (export "fn_L22") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (local.get $t7)) ;; STORE slot 7
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (local.get $t8)) ;; STORE slot 8
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L24
    ...
    (local.set $t13 (i32.add (global.get $TB) (i32.const 0))) ;; LF L16
    ...
    (local.set $t5 (local.get $t9))
    (local.set $t12 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t13 (i32.add (global.get $TB) (i32.const 1))) ;; LF L21
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t13)) ;; entry fn_idx
    ...
    (local.set $t7 (local.get $t9))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L24 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L24
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28))))
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
  ...
  (func $fn_L25 (export "fn_L25") (type $bcpl_fn)
    ...
    (if (i32.gt_s (local.get $t14) (local.get $t15)) (then
      ...
      (local.set $__lab (i32.const 1)) (br $__dispatch)
    )) ;; end block / LAB L26 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L26
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L28 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L28
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L30 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L30
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48))))
  ...
  (func $fn_L33 (export "fn_L33") (type $bcpl_fn)
    ...
    (local.set $t11 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
    (local.set $t12 (i32.const 0))
    (local.set $t13 (i32.const 0))
    (local.set $t14 (i32.const 320))
    (local.set $t15 (i32.const 120))
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L14
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16))))
    (local.set $t14 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
    (local.set $t15 (i32.add (global.get $TB) (i32.const 3))) ;; LF L25
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (global.get $P)) ;; save P
    ...
    (local.set $t10 (local.get $t11))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L36 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L36
    (local.set $t11 (i32.const 240))
    ...
    (local.set $t17 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L13
    ...
    (local.set $t26 (i32.add (global.get $TB) (i32.const 4))) ;; LF L31
  ...
  (func $fn_L37 (export "fn_L37") (type $bcpl_fn)
    ...
    (local.set $t5 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 20)) (local.get $t5)) ;; STORE slot 5
    (local.set $t6 (i32.add (global.get $SB) (i32.const 6))) ;; LLL L38
    (i32.store
    ...
    (i32.store
      (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2))
      (local.get $t6))
    (local.set $t9 (i32.add (global.get $TB) (i32.const 2))) ;; LF L22
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 28)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t14 (i32.add (global.get $TB) (i32.const 5))) ;; LF L33
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t12))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    ...
    (local.set $t5 (local.get $t14))
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L44
    ...
    (local.set $t4 (local.get $t14))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    )) ;; end block / LAB L44 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L44
    ...
    (if (i32.le_s (local.get $t8) (local.get $t9)) (then
      ...
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L40 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L40
    ...
    (global.set $P (i32.add (global.get $P) (i32.const 6)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t10)))
    (local.set $t9 (i32.add (global.get $SB) (i32.const 70))) ;; LSTR
    (local.set $t10 (i32.const 600))
  ...
  (elem $ftab funcref (ref.func $fn_L16) (ref.func $fn_L21) (ref.func $fn_L22) (ref.func $fn_L25) (ref.func $fn_L31) (ref.func $fn_L33) (ref.func $fn_L37))

  ;; static data — passive segment (74 words)
  (data $stat "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\0F\64\6F\6E\65\20\25\6E\20\66\72\61\6D\65\73\0A")
