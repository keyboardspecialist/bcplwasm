(module
  ...
  (func $fn_L35 (export "fn_L35") (type $bcpl_fn)
    ...
    (local.set $t14 (i32.const 320))
    (local.set $t15 (i32.const 240))
    (local.set $t16 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 6)) (i32.const 2)))) ;; LL L16
    (local.set $t17 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (local.get $t10))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    ...
    (local.set $t16 (i32.add (global.get $TB) (i32.const 3))) ;; LF L27
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    ...
    (local.set $t10 (call_indirect $ftable (type $bcpl_fn) (local.get $t16)))
    ...
    (call $__break)
    (local.set $t14 (i32.const 240))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t14))
    (local.set $t12 (local.get $t14))
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L39 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L39
    (local.set $t14 (i32.const 240))
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88)) (local.get $t22)) ;; flush t22 (pre-stack-up)
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (local.get $t23)) ;; flush t23 (pre-stack-up)
    (local.set $t27 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t28 (i32.add (global.get $TB) (i32.const 4))) ;; LF L33
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 104)) (local.get $t28)) ;; entry fn_idx
    (global.set $P (i32.add (global.get $P) (i32.const 24)))
    (local.set $t24 (call_indirect $ftable (type $bcpl_fn) (local.get $t28)))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96)) (local.get $t24)) ;; flush FNAP result
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t25)) ;; entry fn_idx
  ...
  (func $fn_L40 (export "fn_L40") (type $bcpl_fn)
    ...
    (call $__break)
      (local.set $__lab (i32.const 9)) (br $__dispatch) ;; JUMP L42
    )) ;; end block / LAB L41 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L41
    (local.set $t12 (i32.const 0))
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    ...
    (i32.store (i32.shl (local.get $t15) (i32.const 2)) (local.get $t14))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L46 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L46
    ...
    )) ;; end block / LAB L47 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L47
      (local.set $__lab (i32.const 7)) (br $__dispatch) ;; JUMP L45
    )) ;; end block / LAB L43 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L43
    ...
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L49
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L48 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L48
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L45 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L45
    ...
    (i32.store
      ...
      (local.get $t14))
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L50 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L50
  ...
  (func $fn_L51 (export "fn_L51") (type $bcpl_fn)
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L52 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L52
    (local.set $t4 (i32.const 0))
    ;; FNRN
    (local.set $__res (local.get $t4))
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
  ...
  (func $fn_L56 (export "fn_L56") (type $bcpl_fn)
    ...
    (call $__break)
    (local.set $t6 (i32.add (global.get $SB) (i32.const 8))) ;; LLL L57
    (i32.store
    ...
    (call $__break)
    (local.set $t11 (i32.add (global.get $TB) (i32.const 6))) ;; LF L40
    ...
    (local.set $t12 (i32.add (global.get $TB) (i32.const 7))) ;; LF L51
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (local.get $t11))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t6 (local.get $t8))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L62 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L62
    ...
    (local.set $t6 (local.get $t8))
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L64 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L64
    ...
    (if (i32.eqz (local.get $t8)) (then
      ...
      (local.set $__lab (i32.const 8)) (br $__dispatch)
    )) ;; end block / LAB L67 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L67
    ;; line 0:229
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L66 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L66
    ...
    (if (i32.eqz (local.get $t8)) (then
      ...
      (local.set $__lab (i32.const 10)) (br $__dispatch)
    )) ;; end block / LAB L69 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L69
    ;; line 0:230
    ...
    (local.set $t7 (local.get $t8))
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L68 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L68
    (local.set $t8 (i32.const 0))
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    ...
    (local.set $t17 (i32.add (global.get $TB) (i32.const 8))) ;; LF L53
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 56)) (local.get $t14))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 60)) (local.get $t15))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t17)))
      (local.set $__lab (i32.const 12)) (br $__dispatch)
    )) ;; end block / LAB L70 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L70
    ;; line 0:235
    ...
    (if (local.get $t6) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L61 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L61
    ;; line 0:221
  ...
  (elem $ftab funcref (ref.func $fn_L18) (ref.func $fn_L23) (ref.func $fn_L24) (ref.func $fn_L27) (ref.func $fn_L33) (ref.func $fn_L35) (ref.func $fn_L40) (ref.func $fn_L51) (ref.func $fn_L53) (ref.func $fn_L56))
