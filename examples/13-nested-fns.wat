(module
  ...
  (elem $ftab funcref (ref.func $fn_L10) (ref.func $fn_L11) (ref.func $fn_L13) (ref.func $fn_L11) (ref.func $fn_L13))

  ;; static data — passive segment (4 words)
  (data $stat "\0E\69\6E\6E\65\72\28\33\29\20\3D\20\25\6E\0A\00")
