(module
  ...
  (func $fn_L15 (export "fn_L15") (type $bcpl_fn)
    ...
    (call $__break)
    (local.set $t4 (i32.add (global.get $TB) (i32.const 1))) ;; LF L12
    (local.set $t5 (i32.const 0))
    ...
    (call $__break)
    (local.set $t4 (i32.add (global.get $TB) (i32.const 2))) ;; LF L13
    ...
    (call $__break)
    (local.set $t4 (i32.add (global.get $TB) (i32.const 3))) ;; LF L14
  ...
  (func $fn_L16 (export "fn_L16") (type $bcpl_fn)
    ...
    (call $__break)
    (local.set $t6 (i32.add (global.get $TB) (i32.const 4))) ;; LF L15
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 16)) (i32.const 0)) ;; return addr placeholder
  ...
  (elem $ftab funcref (ref.func $fn_L10) (ref.func $fn_L12) (ref.func $fn_L13) (ref.func $fn_L14) (ref.func $fn_L15) (ref.func $fn_L16))

  ;; static data — passive segment (7 words)
  (data $stat "\0E\68\65\6C\6C\6F\20\66\72\6F\6D\20\25\73\0A\00\05\61\6C\69\63\65\00\00\03\62\6F\62")
