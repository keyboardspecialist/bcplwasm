// 46-doom-light: 45 + distance-based light diminishing.
//
// What's new vs 45:
//   - Per-column light: light = sector_light - clamp(cy / LIGHT_DROP, 0, FADE)
//     gives Doom's iconic dark-at-distance look.
//   - Sys_setlight(scale) cached in the runtime, then drawwallcol and
//     drawflatspan multiply per-pixel RGB by scale/256.
//   - light=255 (default at startup) is a fast-path identity.
//
