(module
  ...
  (func $fn_L11 (export "fn_L11") (type $bcpl_fn)
    ...
    (local.set $t4 (i32.load (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2)))) ;; LL L10
  ...
  (func $fn_L12 (export "fn_L12") (type $bcpl_fn)
    ...
    (if (i32.ne (global.get $__bp_armed) (i32.const 0))
        (then (call $__break)))
    (local.set $t8 (i32.add (global.get $TB) (i32.const 0))) ;; LF L11
    ...
    (if (i32.ne (global.get $__bp_armed) (i32.const 0))
        (then (call $__break)))
    (local.set $t8 (i32.add (global.get $SB) (i32.const 1))) ;; LSTR
    ...
    (if (i32.ne (global.get $__bp_armed) (i32.const 0))
        (then (call $__break)))
    (local.set $t6 (i32.add (global.get $SB) (i32.const 7))) ;; LSTR
  ...
  (elem $ftab funcref (ref.func $fn_L11) (ref.func $fn_L12))

  ;; static data — passive segment (13 words)
  (data $stat "\00\00\00\00\15\68\65\6C\6C\6F\20\23\25\6E\20\28\6C\69\6D\69\74\20\25\6E\29\0A\00\00\14\66\69\6E\61\6C\20\68\69\74\20\63\6F\75\6E\74\3A\20\25\6E\0A\00\00\00")
