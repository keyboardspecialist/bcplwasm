(module
  ...
  (func $fn_L20 (export "fn_L20") (type $bcpl_fn)
    ...
    (local.set $t5 (local.get $t9))
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L22
    ...
    (if (local.get $t9) (then
      ...
      (local.set $__lab (i32.const 4)) (br $__dispatch) ;; JUMP L24
    )) ;; end block / LAB L23 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L23
    ...
    )) ;; end block / LAB L24 = idx 4
    (if (i32.eq (local.get $__lab) (i32.const 4)) (then ;; L24
    (local.set $t9 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
  ...
  (func $fn_L25 (export "fn_L25") (type $bcpl_fn)
    ...
    (local.set $t9 (i32.add (global.get $TB) (i32.const 0))) ;; LF L20
  ...
  (func $fn_L26 (export "fn_L26") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 36)) (local.get $t9)) ;; STORE slot 9
      (local.set $__lab (i32.const 2)) (br $__dispatch) ;; JUMP L28
    ...
    (local.set $t14 (i32.add (global.get $TB) (i32.const 0))) ;; LF L20
    ...
    (local.set $t13 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    (local.set $t14 (i32.add (global.get $TB) (i32.const 1))) ;; LF L25
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52)) (local.get $t13))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 40)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44)) (i32.const 0)) ;; return addr placeholder
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 48)) (local.get $t14)) ;; entry fn_idx
    ...
    (local.set $t8 (local.get $t10))
      (local.set $__lab (i32.const 2)) (br $__dispatch)
    )) ;; end block / LAB L28 = idx 2
    (if (i32.eq (local.get $__lab) (i32.const 2)) (then ;; L28
    (local.set $t10 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 32))))
  ...
  (func $fn_L29 (export "fn_L29") (type $bcpl_fn)
    ...
    ;; RES L30: save result, jump to RSTACK
    ...
    ;; RES L32: save result, jump to RSTACK
    (local.set $__res (local.get $t16))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
      (local.set $__lab (i32.const 3)) (br $__dispatch)
    )) ;; end block / LAB L33 = idx 3
    (if (i32.eq (local.get $__lab) (i32.const 3)) (then ;; L33
    (local.set $t16 (i32.const 1))
    ;; RES L32: save result, jump to RSTACK
    (local.set $__res (local.get $t16))
      (local.set $__lab (i32.const 4)) (br $__dispatch)
    ...
    (local.set $t17 (local.get $t20))
      (local.set $__lab (i32.const 8)) (br $__dispatch) ;; JUMP L38
    )) ;; end block / LAB L36 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L36
    ...
    )) ;; end block / LAB L38 = idx 8
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L38
    ...
    (local.set $t18 (local.get $t20))
      (local.set $__lab (i32.const 10)) (br $__dispatch) ;; JUMP L41
    )) ;; end block / LAB L39 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L39
    (local.set $t20 (i32.const 1024))
    ...
    )) ;; end block / LAB L41 = idx 10
    (if (i32.eq (local.get $__lab) (i32.const 10)) (then ;; L41
    (local.set $t20 (i32.const 1))
    ...
    )) ;; end block / LAB L42 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L42
    ...
    (local.set $t19 (local.get $t22))
      (local.set $__lab (i32.const 13)) (br $__dispatch) ;; JUMP L46
    )) ;; end block / LAB L44 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L44
    ...
    )) ;; end block / LAB L46 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L46
    (local.set $t22 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 52))))
    ...
    (if (i32.lt_s (local.get $t22) (local.get $t23)) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L48 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L48
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (i32.const 0))
    )) ;; end block / LAB L47 = idx 15
    (if (i32.eq (local.get $__lab) (i32.const 15)) (then ;; L47
    ...
    ;; RES L50: save result, jump to RSTACK
    (local.set $__res (local.get $t22))
      (local.set $__lab (i32.const 17)) (br $__dispatch)
      (local.set $__lab (i32.const 16)) (br $__dispatch)
    )) ;; end block / LAB L51 = idx 16
    (if (i32.eq (local.get $__lab) (i32.const 16)) (then ;; L51
    ...
    (local.set $__res (local.get $t22))
      (local.set $__lab (i32.const 17)) (br $__dispatch)
    )) ;; end block / LAB L50 = idx 17
    (if (i32.eq (local.get $__lab) (i32.const 17)) (then ;; L50
    ;; RSTACK 22
    ...
    (local.set $t23 (local.get $t25))
      (local.set $__lab (i32.const 19)) (br $__dispatch) ;; JUMP L54
      (local.set $__lab (i32.const 18)) (br $__dispatch)
    )) ;; end block / LAB L52 = idx 18
    (if (i32.eq (local.get $__lab) (i32.const 18)) (then ;; L52
    ...
    )) ;; end block / LAB L54 = idx 19
    (if (i32.eq (local.get $__lab) (i32.const 19)) (then ;; L54
    ...
    (local.set $t23 (local.get $t24))
      (local.set $__lab (i32.const 20)) (br $__dispatch)
    )) ;; end block / LAB L55 = idx 20
    (if (i32.eq (local.get $__lab) (i32.const 20)) (then ;; L55
    ...
    (return (i32.const 0))
      (local.set $__lab (i32.const 21)) (br $__dispatch)
    )) ;; end block / LAB L49 = idx 21
    (if (i32.eq (local.get $__lab) (i32.const 21)) (then ;; L49
    (local.set $t22 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80))))
    (local.set $t23 (i32.const 1))
    (local.set $t22 (i32.add (local.get $t22) (local.get $t23)))
    ...
    (if (i32.le_s (local.get $t22) (local.get $t23)) (then
      ...
      (local.set $__lab (i32.const 22)) (br $__dispatch)
    )) ;; end block / LAB L43 = idx 22
    (if (i32.eq (local.get $__lab) (i32.const 22)) (then ;; L43
  ...
  (func $fn_L56 (export "fn_L56") (type $bcpl_fn)
    ...
    (local.set $t35 (i32.add (global.get $TB) (i32.const 3))) ;; LF L29
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96)) (local.get $t28))
    (local.set $t24 (local.get $t28))
      (local.set $__lab (i32.const 6)) (br $__dispatch) ;; JUMP L62
    ...
    (local.set $t24 (local.get $t28))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L64 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L64
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    ...
    (if (i32.le_s (local.get $t16) (local.get $t17)) (then
      ...
      (local.set $__lab (i32.const 7)) (br $__dispatch)
    )) ;; end block / LAB L58 = idx 7
    (if (i32.eq (local.get $__lab) (i32.const 7)) (then ;; L58
  ...
  (func $fn_L65 (export "fn_L65") (type $bcpl_fn)
    ...
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12)) (local.get $t3)) ;; flush t3 (pre-stack-up)
      (local.set $__lab (i32.const 9)) (br $__dispatch) ;; JUMP L67
    ...
    (i32.store (i32.shl (local.get $t15) (i32.const 2)) (local.get $t14))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L74 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L74
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    ...
    (if (i32.eq (local.get $__lab) (i32.const 8)) (then ;; L75
      (local.set $__lab (i32.const 9)) (br $__dispatch)
    )) ;; end block / LAB L67 = idx 9
    (if (i32.eq (local.get $__lab) (i32.const 9)) (then ;; L67
  ...
  ;; BCPL fn key_down (L76)
  (func $fn_L76 (export "fn_L76") (type $bcpl_fn)
    (local $__lab i32)
    (local $__res i32)
    (local $t0 i32)
    (local $t1 i32)
    ...
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
    (return (local.get $__res))
    )) ;; end block / LAB L77 = idx 1
    (if (i32.eq (local.get $__lab) (i32.const 1)) (then ;; L77
    (local.set $t4 (i32.const 0))
    ;; FNRN
    (local.set $__res (local.get $t4))
    (global.set $P (i32.load (i32.shl (global.get $P) (i32.const 2))))
  ...
  (func $fn_L83 (export "fn_L83") (type $bcpl_fn)
    ...
    (local.set $t16 (i32.add (global.get $SB) (i32.const 10))) ;; LLL L84
    (i32.store
      (i32.shl (i32.add (global.get $SB) (i32.const 0)) (i32.const 2))
      (local.get $t16))
    (local.set $t19 (i32.const 80))
    (local.set $t20 (i32.add (global.get $SB) (i32.const 74))) ;; LSTR
    ...
    (local.set $t19 (i32.const 80))
    (local.set $t20 (i32.add (global.get $SB) (i32.const 77))) ;; LSTR
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t22 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t20))
    ...
    (local.set $t19 (i32.const 80))
    (local.set $t20 (i32.add (global.get $SB) (i32.const 80))) ;; LSTR
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t22 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 12))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t20))
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 83))) ;; LSTR
    ...
    (i32.store
      ...
      (local.get $t16))
    (local.set $t19 (i32.add (global.get $SB) (i32.const 95))) ;; LSTR
    (local.set $t20 (i32.const 0))
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 44))))
    (local.set $t22 (i32.add (global.get $TB) (i32.const 8))) ;; LF L81
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 80)) (local.get $t20))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t21))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 97))) ;; LSTR
    (local.set $t20 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (i32.const 0)) ;; return addr placeholder
    ...
    (i32.store
      ...
      (local.get $t16))
    (local.set $t19 (i32.add (global.get $SB) (i32.const 77))) ;; LSTR
    (local.set $t20 (i32.const 1))
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t22 (i32.add (global.get $TB) (i32.const 8))) ;; LF L81
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 80))) ;; LSTR
    (local.set $t20 (i32.const 1))
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t22 (i32.add (global.get $TB) (i32.const 8))) ;; LF L81
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 109))) ;; LSTR
    (local.set $t20 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (i32.const 0)) ;; return addr placeholder
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t20)))
      (local.set $__lab (i32.const 5)) (br $__dispatch)
    )) ;; end block / LAB L90 = idx 5
    (if (i32.eq (local.get $__lab) (i32.const 5)) (then ;; L90
      (local.set $__lab (i32.const 6)) (br $__dispatch)
    )) ;; end block / LAB L89 = idx 6
    (if (i32.eq (local.get $__lab) (i32.const 6)) (then ;; L89
    (local.set $t19 (i32.add (global.get $SB) (i32.const 114))) ;; LSTR
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 74))) ;; LSTR
    (local.set $t20 (i32.const 2))
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 24))))
    (local.set $t22 (i32.add (global.get $TB) (i32.const 8))) ;; LF L81
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 117))) ;; LSTR
    (local.set $t20 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t19 (i32.add (global.get $TB) (i32.const 2))) ;; LF L26
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (i32.const 0)) ;; return addr placeholder
    ...
    (local.set $t19 (i32.add (global.get $SB) (i32.const 123))) ;; LSTR
    ...
    (if (i32.eqz (local.get $t16)) (then
      ...
      (local.set $__lab (i32.const 11)) (br $__dispatch)
    )) ;; end block / LAB L95 = idx 11
    (if (i32.eq (local.get $__lab) (i32.const 11)) (then ;; L95
    (local.set $t16 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (local.get $t16)) ;; STORE slot 16
    (local.set $t17 (i32.const 0))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (local.get $t17)) ;; STORE slot 17
    (local.set $t21 (i32.add (global.get $TB) (i32.const 5))) ;; LF L65
    ...
    (local.set $t22 (i32.add (global.get $TB) (i32.const 6))) ;; LF L76
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t21))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (i32.const 0)) ;; return addr placeholder
    ...
    (if (i32.eqz (local.get $t18)) (then
      ...
      (local.set $__lab (i32.const 12)) (br $__dispatch)
    )) ;; end block / LAB L98 = idx 12
    (if (i32.eq (local.get $__lab) (i32.const 12)) (then ;; L98
    ...
    (local.set $t16 (local.get $t18))
      (local.set $__lab (i32.const 13)) (br $__dispatch)
    )) ;; end block / LAB L97 = idx 13
    (if (i32.eq (local.get $__lab) (i32.const 13)) (then ;; L97
    ...
    (if (i32.eqz (local.get $t18)) (then
      ...
      (local.set $__lab (i32.const 14)) (br $__dispatch)
    )) ;; end block / LAB L100 = idx 14
    (if (i32.eq (local.get $__lab) (i32.const 14)) (then ;; L100
    (local.set $t18 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    (local.set $t19 (i32.const 1))
    ...
    (if (i32.eqz (local.get $t18)) (then
      ...
      (local.set $__lab (i32.const 16)) (br $__dispatch)
    )) ;; end block / LAB L102 = idx 16
    (if (i32.eq (local.get $__lab) (i32.const 16)) (then ;; L102
    ...
    (local.set $t17 (local.get $t18))
      (local.set $__lab (i32.const 17)) (br $__dispatch)
    )) ;; end block / LAB L101 = idx 17
    (if (i32.eq (local.get $__lab) (i32.const 17)) (then ;; L101
    ...
    (if (i32.eqz (local.get $t18)) (then
      ...
      (local.set $__lab (i32.const 18)) (br $__dispatch)
    )) ;; end block / LAB L104 = idx 18
    (if (i32.eq (local.get $__lab) (i32.const 18)) (then ;; L104
    ...
    (local.set $t17 (local.get $t18))
      (local.set $__lab (i32.const 19)) (br $__dispatch)
    )) ;; end block / LAB L103 = idx 19
    (if (i32.eq (local.get $__lab) (i32.const 19)) (then ;; L103
    (local.set $t18 (i32.const 0))
    (local.set $t19 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64))))
    ...
    (local.set $t27 (i32.add (global.get $TB) (i32.const 7))) ;; LF L78
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (local.get $t23))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 96)) (local.get $t24))
    ...
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t27)))
      (local.set $__lab (i32.const 20)) (br $__dispatch)
    )) ;; end block / LAB L105 = idx 20
    (if (i32.eq (local.get $__lab) (i32.const 20)) (then ;; L105
    (local.set $t18 (i32.const 0))
    (local.set $t19 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68))))
    (if (i32.eq  (local.get $t18) (local.get $t19)) (then
      (local.set $__lab (i32.const 21)) (br $__dispatch)
    ...
    (local.set $t5 (local.get $t18))
      (local.set $__lab (i32.const 21)) (br $__dispatch)
    )) ;; end block / LAB L106 = idx 21
    (if (i32.eq (local.get $__lab) (i32.const 21)) (then ;; L106
    (local.set $t21 (i32.load (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 12))))
    ...
    (local.set $t24 (i32.add (global.get $TB) (i32.const 4))) ;; LF L56
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 84)) (local.get $t21))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 88)) (local.get $t22))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 92)) (local.get $t23))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 72)) (global.get $P)) ;; save P
    ...
    (if (local.get $t16) (then
      ...
      (local.set $__lab (i32.const 22)) (br $__dispatch)
    )) ;; end block / LAB L96 = idx 22
    (if (i32.eq (local.get $__lab) (i32.const 22)) (then ;; L96
    ...
    (global.set $P (i32.add (global.get $P) (i32.const 16)))
    (drop (call_indirect $ftable (type $bcpl_fn) (local.get $t20)))
    (local.set $t19 (i32.add (global.get $SB) (i32.const 129))) ;; LSTR
    (local.set $t20 (i32.load (i32.add (i32.shl (global.get $G) (i32.const 2)) (i32.const 376))))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 76)) (local.get $t19))
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 64)) (global.get $P)) ;; save P
    (i32.store (i32.add (i32.shl (global.get $P) (i32.const 2)) (i32.const 68)) (i32.const 0)) ;; return addr placeholder
  ...
  (elem $ftab funcref (ref.func $fn_L20) (ref.func $fn_L25) (ref.func $fn_L26) (ref.func $fn_L29) (ref.func $fn_L56) (ref.func $fn_L65) (ref.func $fn_L76) (ref.func $fn_L78) (ref.func $fn_L81) (ref.func $fn_L83))

  ;; static data — passive segment (133 words)
  (data $stat "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\00\00\00\00\01\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\09\62\72\69\63\6B\2E\70\6E\67\00\00\09\73\74\6F\6E\65\2E\70\6E\67\00\00\0B\63\68\65\63\6B\65\72\2E\70\6E\67\2D\4E\6F\20\77\61\6C\6C\20\74\65\78\74\75\72\65\2E\20\55\70\6C\6F\61\64\20\62\72\69\63\6B\2E\70\6E\67\20\69\6E\20\41\73\73\65\74\73\2E\0A\00\00\07\73\6B\79\2E\70\6E\67\2C\4E\6F\20\73\6B\79\2E\70\6E\67\20\61\73\73\65\74\2E\20\53\6B\79\20\63\6F\6C\75\6D\6E\20\77\69\6C\6C\20\62\65\20\62\6C\61\6E\6B\2E\0A\00\00\00\12\4E\6F\20\66\6C\6F\6F\72\20\74\65\78\74\75\72\65\2E\0A\00\08\77\6F\6F\64\2E\70\6E\67\00\00\00\14\4E\6F\20\63\65\69\6C\69\6E\67\20\74\65\78\74\75\72\65\2E\0A\00\00\00\15\77\61\6C\6C\20\25\6E\78\25\6E\20\20\73\6B\79\5F\77\3D\25\6E\0A\00\00\0D\72\61\79\73\6B\20\65\78\69\74\65\64\0A\00\00")
